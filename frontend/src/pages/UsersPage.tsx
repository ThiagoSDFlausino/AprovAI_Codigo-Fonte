...
const UsersPage = () => {
  ...
  useEffect(() => { UserController.PesquisaUsuario(setUsers, setLoading, toast); }, []);
  ...
  const handleSave = async (formData) => {
    if (modal.mode === 'create') {
      await UserController.CadastroUsuario(formData, setUsers, () => setModal(null), toast);
    } else {
      await UserController.AtualizarUsuario(modal.user.id, formData, setUsers, () => setModal(null), toast);
    }
  };

  const handleDelete = async (id) => {
    await UserController.DeletarUsuario(id, setUsers, toast);
